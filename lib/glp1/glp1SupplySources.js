...
/** Fixed Google News queries on official domains (supply lane, not trends). */
const GLP1_SUPPLY_NEWS_QUERIES = [
  'site:fda.gov (semaglutide OR tirzepatide OR Wegovy OR Ozempic) when:90d',
  'site:novonordisk.com (Wegovy OR semaglutide OR Ozempic) when:90d',
  'site:investor.lilly.com (Foundayo OR orforglipron OR Zepbound OR tirzepatide) when:90d',
];
