...
/** Subscription or registration required for full article read */
...
function buildOpenAiPrompt(limitPerTerm, maxItems) {
  return (
    ...
    MAX_AGE_DAYS +
    ' days.\n\n' +
    'Prefer articles on: reuters.com, fda.gov, npr.org, apnews.com, medscape.com.\n' +
    'Exclude subscription-only publishers (e.g. STAT), CNBC, Healthline, GoodRx, Forbes, and Google News links.\n\n' +
